...
class OperationsTest(unittest.TestCase):
    ...
    def test_report_normalization(self):
        ...
        # sourceReportedAt must track the Patrol clock (6:15 AM AEST), not SlopeMaintenance (7:00 AM)
        self.assertEqual(falls.sourceReportedAt, combined_local("12 July 2026", "6:15 AM"))
        self.assertEqual(falls.provenance["slopeMaintenanceReportedAt"], combined_local("12 July 2026", "7:00 AM"))
        self.assertEqual(falls.provenance["siteDepthsCm"], {"villageBowl": 43, "sunValley": 49, "northSide": 34})
